                ...
                .then(async () => {
                    if (groupInfo.id) {
                        setTimeout(async () => {
                            ...
                            await client.sendText(groupInfo.id, `Hai guys 👋 perkenalkan saya SANBOT. Untuk melihat perintah atau menu yang tersedia pada bot, kirim *${prefix}menu*. Tapi sebelumnya pahami dulu *${prefix}tnc*`)
                        }, 2000)
                ...
                .then(async () => {
                    if (gInfo.id) {
                        setTimeout(async () => {
                            ...
                            await client.sendText(gInfo.id, `Hai guys 👋 perkenalkan saya SANBOT. Untuk melihat perintah atau menu yang tersedia pada bot, kirim *${prefix}menu*. Tapi sebelumnya pahami dulu *${prefix}tnc*`)
                        }, 2000)

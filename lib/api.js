...
const artinama = (nama) => new Promise((resolve, reject) => {
    get(`https://api.zeks.me/api/artinama?apikey=apivinz&nama=${encodeURIComponent(nama)}`)
        .then((res) => {
...
const artimimpi = (q) => new Promise((resolve, reject) => {
    get(`https://api.zeks.me/api/artimimpi?apikey=apivinz&q=${encodeURIComponent(q)}`)
        .then((res) => {
            resolve(res.data)
        })
        .catch((err) => {
...
const cekjodoh = async (nama,pasangan) => new Promise((resolve, reject) => {
	...
	.then((res) => {
		...
		resolve({link: res.data.result.thumb, text: textc})
	})
	.catch((err) => {
		reject(err)
	})
...
const sid = async (url) => new Promise((resolve, reject) => {
    console.log(color('[LOGS]', 'grey'), 'Creating short url...')
	axios.get(`https://api.zeks.me/api/sid-shortener?apikey=apivinz&url=${url}`)
	.then((res) => {
        resolve(res.data)
    })
    .catch((err) => {
...
const shortener = async (url) => new Promise((resolve, reject) => {
    console.log(color('[LOGS]', 'grey'), 'Creating short url...')
	axios.get(`https://api.zeks.me/api/urlshort?apikey=apivinz&url=${url}`)
	.then((res) => {
        resolve(res.data)
    })
    .catch((err) => {
